...
const Home = () => {
  return (
    <div className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                key={index}
                className="card p-8 text-center hover:transform hover:scale-105"
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-r from-purple-50 to-accent-50">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <Link to="/register" className="bg-purple-600 hover:bg-purple-700 text-white font-medium text-lg px-8 py-4 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-glow hover:shadow-glow-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2">
            Create Your Account
          </Link>
        </div>
      </section>
